...
HD_PWD='D:/vlsi-proj/riscV_project/riscV_synth/riscV_synth.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log riscVTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source riscVTop.tcl
